...
(function() {
    ...
    // Override JSON.parse with logging
    JSON.parse = function(text, reviver) {
        try {
            // Log what's being parsed
            console.log('[DEBUG] JSON.parse called with:', typeof text, text);
            
            // Check if text is already an object
            if (typeof text === 'object' && text !== null) {
                console.warn('[DEBUG] JSON.parse received an object instead of string:', text);
                // Try to handle it gracefully by returning the object
                return text;
            }
            ...
            console.error('[DEBUG] JSON.parse input was:', text);
            throw error;
        }
    };
    ...
    // Override addEventListener to log message events
    EventTarget.prototype.addEventListener = function(type, listener, options) {
        if (type === 'message') {
            console.log('[DEBUG] Message event listener added to:', this);
        }
